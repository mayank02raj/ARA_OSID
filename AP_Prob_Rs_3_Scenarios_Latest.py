...
for c in rel_df.columns:
    if c.lower().strip() in ("mapping type","mapping_type","relationship type","relationship_type","type"):
...
# =========================================================
import sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "7. ARA- OSID "))
from ara_osid_v1 import run_ara_osid  # type: ignore[import-not-found]
